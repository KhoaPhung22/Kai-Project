...
class GlamiraSpider(scrapy.Spider):
    name = 'necklaces-green-diamond'
    start_urls = ['https://www.glamira.com/diamond-necklaces/green-diamond/'
    ]
    ...
    def parse(self, response):
        ...
        if self.current_page <= self.total_pages:
            next_page_url = f'https://www.glamira.com/diamond-necklaces/green-diamond/?p={self.current_page}'
