...
class GlamiraSpider(scrapy.Spider):
    name = 'necklaces-yellow-diamond'
    start_urls = ['https://www.glamira.com/diamond-necklaces/yellow-diamond/'
    ]
    # categories = [
    #     # 'diamond-rings',
    #     'yellow-diamond',
    ...
    def parse(self, response):
        ...
        if self.current_page <= self.total_pages:
            next_page_url = f'https://www.glamira.com/diamond-necklaces/yellow-diamond/?p={self.current_page}'
