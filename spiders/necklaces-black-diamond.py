...
class GlamiraSpider(scrapy.Spider):
    name = 'necklaces-black-diamond'
    start_urls = ['https://www.glamira.com/diamond-necklaces/black-diamond'
    ]
    # categories = [
    #     # 'diamond-rings',
    #     'black-diamond',
    ...
    def parse(self, response):
        ...
        if self.current_page <= self.total_pages:
            next_page_url = f'https://www.glamira.com/diamond-necklaces/black-diamond/?p={self.current_page}'
