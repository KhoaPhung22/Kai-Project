...
class GlamiraSpider(scrapy.Spider):
    name = 'necklaces-blue-diamond'
    start_urls = ['https://www.glamira.com/diamond-necklaces/blue-diamond'
    ]
    ...
    def parse(self, response):
        ...
        if self.current_page <= self.total_pages:
            next_page_url = f'https://www.glamira.com/diamond-necklaces/blue-diamond/?p={self.current_page}'
