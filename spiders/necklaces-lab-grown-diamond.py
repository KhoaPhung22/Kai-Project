...
class GlamiraSpider(scrapy.Spider):
    name = 'necklaces-lab-grown-diamond'
    start_urls = ['https://www.glamira.com/diamond-necklaces/lab-grown-diamond/'
    ]
    # categories = [
    #     # 'diamond-rings',
    ...
    def parse(self, response):
        ...
        if self.current_page <= self.total_pages:
            next_page_url = f'https://www.glamira.com/diamond-necklaces/lab-grown-diamond/?p={self.current_page}'
