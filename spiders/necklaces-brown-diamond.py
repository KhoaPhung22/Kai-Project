...
class GlamiraSpider(scrapy.Spider):
    name = 'necklaces-brown-diamond'
    start_urls = ['https://www.glamira.com/diamond-necklaces/brown-diamond/'
    ]
    ...
    def parse(self, response):
        ...
        if self.current_page <= self.total_pages:
            next_page_url = f'https://www.glamira.com/diamond-necklaces/brown-diamond/?p={self.current_page}'
