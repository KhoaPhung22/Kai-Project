...
class GlamiraSpider(scrapy.Spider):
    ...
    start_urls = ['https://www.glamira.com/diamond-rings/',
                #   'https://www.glamira.com/diamond-rings/black-diamond/',
                #   'https://www.glamira.com/diamond-rings/yellow-diamond/',
                #   'https://www.glamira.com/diamond-rings/blue-diamond/',
                #   'https://www.glamira.com/diamond-rings/green-diamond/',
                #   'https://www.glamira.com/diamond-rings/brown-diamond/',
                #   'https://www.glamira.com/diamond-rings/lab-grown-diamond/'
    ]
    # categories = [
    #     # 'diamond-rings',
    #     'black-diamond',
    ...
    def __init__(self):
        ...
        self.current_page = 1
        self.total_pages = 109  # Number of pages to crawl
    ...
    def parse(self, response):
        ...
        if self.current_page <= self.total_pages:
            next_page_url = f'https://www.glamira.com/diamond-rings/?p={self.current_page}'
